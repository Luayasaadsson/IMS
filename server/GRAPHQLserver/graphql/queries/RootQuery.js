...
//  denna kod implementerat funktionen för att hämta en lista över alla tillverkare som företaget gör affärer med.
...
const ManufacturerStockType = require("../types/ManufacturerStockType");
const UniqueManufacturerResultType = require("../types/UniqueManufacturerResultType");
const ManufacturerType = require("../types/ManufacturerType"); // Importera ManufacturerType
